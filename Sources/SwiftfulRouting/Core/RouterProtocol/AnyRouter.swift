...
public struct AnyRouter: Sendable, Router {
    ...
    ///   - location: Which router to display modal on. Use .topRouter to show above all screens (e.g. above a tab bar).
    ...
    /// - Parameter location: Which router's modal to dismiss. Use .topRouter to dismiss the last modal on the topmost screen.
